...
### Changed
- Web component icon generation logic adjusted for the carbon and custom icons. The `SVG` tag is now pre-generated and directly part for the Icon web component. 
