...
export class WebComponentIcon extends BaseIcon {
  render() {
    return html`<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M7 5.5H6V8.5H7V5.5Z" fill="currentColor" /><path d="M4.5 6.5H3.5V8.5H4.5V6.5Z" fill="currentColor" /><path d="M2 3.5H1V8.5H2V3.5Z" fill="currentColor" /><path d="M15 14.2929L11.2239 10.5169C12.0198 9.56275 12.5 8.33665 12.5 7C12.5 3.9673 10.0327 1.5 7 1.5C5.7987 1.5 4.65735 1.88035 3.69935 2.6001L4.29995 3.39965C5.0834 2.81105 6.0171 2.5 7 2.5C9.4813 2.5 11.5 4.51855 11.5 7C11.5 9.48145 9.4813 11.5 7 11.5C5.5713 11.5 4.25905 10.844 3.39965 9.69995L2.6001 10.3008C3.65015 11.6982 5.2539 12.5 7 12.5C8.33665 12.5 9.56275 12.0198 10.5168 11.2239L14.2929 15L15 14.2929Z" fill="currentColor" /></svg>`;
  }
}
