...
const content: IIconContent[] = [
  {
    ...
    attrs: {
      d:
        `M12 9C12.445 9 12.88 8.86804 13.25 8.6208C13.62 8.37357 13.9085 8.02217 14.0788 7.61103C14.249 7.1999 14.2936 6.7475 14.2068 6.31104C14.12 5.87459 13.9057 5.47367 13.591 5.15901C13.2763
  ...
  },
  {
    ...
    attrs: {
      d:
        `M3 1.5H17.25C17.6478 1.5 18.0293 1.65803 18.3106 1.93934C18.5919 2.22064 18.75 2.60218 18.75 3V4.5H21C21.8284 4.5 22.5 5.17157 22.5 6V21C22.5 21.8284 21.8284 22.5 21 22.5H6C5.17157 22.5
...
export const ICON_NAME = 'icon-images';
