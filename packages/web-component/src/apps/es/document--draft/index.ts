...
const content: IIconContent[] = [
  {
    ...
    attrs: {
      d:
        `M6 21H9V22.5H6C5.60218 22.5 5.22067 22.342 4.93936 22.0607C4.65806 21.7794 4.5 21.3978 4.5 21V3C4.5 2.60218 4.65806 2.22065 4.93936 1.93934C5.22067 1.65804 5.60218 1.5 6 1.5H13.5C13.5986
  ...
  },
  {
    ...
    attrs: {
      d:
        `M20.0325 12.2174L22.2825 14.4674C22.3528 14.5371 22.4086 14.6201 22.4467 14.7115C22.4847 14.8029 22.5043 14.9009 22.5043 14.9999C22.5043 15.0989 22.4847 15.1969 22.4467 15.2883C22.4086
...
export const ICON_NAME = 'icon-document-draft';
