...
const content: IIconContent[] = [
  {
    ...
    attrs: {
      d:
        `M6 21.0001H10.5V22.5001H6C5.60218 22.5001 5.22067 22.342 4.93936 22.0607C4.65806 21.7794 4.5 21.3979 4.5 21.0001V3.00006C4.5 2.60224 4.65806 2.22071 4.93936 1.9394C5.22067 1.6581 5.60218
  ...
  },
  {
    ...
    attrs: {
      d:
        `M17.25 22.4996C16.2116 22.4996 15.1966 22.1917 14.3333 21.6149C13.4699 21.038 12.797 20.218 12.3996 19.2587C12.0023 18.2994 11.8983 17.2438 12.1009 16.2254C12.3035 15.207 12.8035 14.2716
...
export const ICON_NAME = 'icon-document-warning';
